...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputData("Takoyaki", "artikel_1.html");
        inputData("Ramen", "artikel_2.html");
        inputData("Sushi", "artikel_3.html");
        inputData("Onigiri Tuna Mayo", "artikel_4.html");
        inputData("Mochi", "artikel_5.html");
        inputData("Sashimi", "artikel_6.html");
        inputData("Dorayaki", "artikel_7.html");
        inputData("Karaage", "artikel_8.html");
